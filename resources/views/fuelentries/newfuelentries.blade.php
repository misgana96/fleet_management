...
@section('content')
<div class="content"> 
<h4 class="header">Fuel Entry<hr/></h4>         
        ...
        <div class="col-lg-7 lg-offset-2">
         ...
         <div class="row form-group{{ $errors->has('fuelentry_date') ? ' has-error' : '' }}">
                <label for="fuelentry_date" class="control-label col-sm-3">Date: </label>
                    ...
                    <div class="col-sm-7"><input id="vehicle_type" type="date" class="form-control " name="fuelentry_date" value="{{ old('fuelentry_date') }}" >
            ...
            <div class="row form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                <label for="amount" class="control-label col-sm-3">Amount: </label>
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="formControlRange" name="amount" value="{{ old('amount') }}">
